...
using CORE.DMS.CoreBusiness;

namespace vpb.app.business
{
    namespace ktnb.CoreData
    {
        internal class db_BoTieuChiDanhGiaNam
        {
            #region Private variables
            private Database _db = null;
            private UserContext mvarUserContext;
            private static db_BoTieuChiDanhGiaNam mvarInstance;
            ...
            /// <returns></returns>
            public static db_BoTieuChiDanhGiaNam Instance(UserContext usrCTX)
            {
                if (mvarInstance == null)
                    mvarInstance = new db_BoTieuChiDanhGiaNam(usrCTX);
                return mvarInstance;
            }
            /// <summary>
            /// db_BoTieuChiDanhGiaNam
            /// </summary>
            /// <param name="usrCTX"></param>
            public db_BoTieuChiDanhGiaNam(UserContext usrCTX)
            {
            ...
            public db_BoTieuChiDanhGiaNam(UserContext usrCTX, string databaseName)
            {
                mvarUserContext = usrCTX;
                if (mvarUserContext != null)
