...
<asp:Content ID="Content1" ContentPlaceHolderID="FormContent" runat="server">    
    <div class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                 <asp:Button runat="server" ID="btnSearch" CssClass="btn btn-default" Text="Đánh giá rủi ro" />
            </div>
        </div>
    </div>    
    <br />
...
<asp:Content ID="Content3" ContentPlaceHolderID="ButtonExtend" runat="server">    
    <asp:Button runat="server" ID="btnImport" Text="Import File đánh giá" CssClass="btn btn-primary" />
    <asp:Button runat="server" ID="btnExport" Text="Export File đánh giá" CssClass="btn btn-primary" />
</asp:Content>
