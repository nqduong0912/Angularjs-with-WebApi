<%@ Page Title="" Language="C#" MasterPageFile="~/Share/Wsp.master" AutoEventWireup="true" CodeBehind="ChamDiemSuaDoi.aspx.cs" Inherits="VPB_KTNB.Modules.Processes.KeHoachNam.ChamDiemSuaDoi" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="FormContent" runat="server">
     <div class="form-horizontal">
        <div class="form-group">
           ...
           <div class="col-sm-6">
               <asp:Button runat="server" ID="btnSearch" CssClass="btn btn-default" Text="Sửa đổi điểm" />
           </div>
        </div>
        <div class="form-group">
