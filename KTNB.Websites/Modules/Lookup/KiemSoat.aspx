<%@ Page Title="" Language="C#" MasterPageFile="~/Share/Wsp.master" AutoEventWireup="true" CodeBehind="KiemSoat.aspx.cs" Inherits="VPB_TDHS.Modules.Lookup.KiemSoat" %>
            ...
            <C1WebGrid:C1WebGrid runat="server" ID="dataCtrl" Width="100%" DataSourceID="ObjectDataSource1"
                    ...
                    <Columns>
                        ...
                        <C1WebGrid:C1BoundColumn HeaderText="Tên kiểm soát" DataField="Tên kiểm soát">
                          ...
                          <C1WebGrid:C1BoundColumn HeaderText="Tên rủi ro" DataField="Tên rủi ro">
                            <ItemStyle VerticalAlign="Top" HorizontalAlign="Left" />
                        </C1WebGrid:C1BoundColumn>
...
<script type="text/javascript">
    ...
    /*********************************************************/
    function newform() {
        window.location.href = "KiemSoat_Load.aspx";
    }
