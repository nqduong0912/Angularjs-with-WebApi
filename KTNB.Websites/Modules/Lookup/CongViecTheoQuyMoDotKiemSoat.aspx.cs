...
{
    public partial class CongViecTheoQuyMoDotKiemSoat : PageBase
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            #region init form
            base.InitForm("Công việc theo mục tiêu kiểm soát", string.Empty, _doctypeid, 0);
        ...
        {
            string DocFields = "PK_DocumentID,Status,[Tên công việc],[Số lượng trưởng đoàn],[Diễn giải]";
            string PropertyFields = "Tên công việc,Số lượng trưởng đoàn,Diễn giải";
