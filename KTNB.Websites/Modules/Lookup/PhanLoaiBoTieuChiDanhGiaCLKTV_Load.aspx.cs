...
{
    public partial class PhanLoaiBoTieuChiDanhGiaCLKTV_Load : PageBase
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            #region init form
            string caption = "Thêm mới phân loại bộ tiêu chí đánh giá";
            if (!string.IsNullOrEmpty(_documentid))
                caption = "Thông tin phân loại bộ tiêu chí đánh giá";
