...
{
    public partial class PhanLoaiBoTieuChiDanhGiaCLKTV : PageBase
    {
        #region initiation page variables
        protected string _action = string.Empty;
        protected string _doctypeid = DOCTYPE.PHANLOAI_BOTIEUCHI_DANHGIA_CLKTV;
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            #region init form
            base.InitForm("Phân loại bộ tiêu chí đánh giá", string.Empty, _doctypeid, 0);
        ...
        {
            string DocFields = "PK_DocumentID,Status,[Tên phân loại bộ tiêu chí đánh giá]";
            string PropertyFields = "Tên phân loại bộ tiêu chí đánh giá";
