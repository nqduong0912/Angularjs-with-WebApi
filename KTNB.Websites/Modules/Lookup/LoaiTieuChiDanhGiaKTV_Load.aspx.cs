...
{
	public partial class LoaiTieuChiDanhGiaKTV_Load : PageBase
	{
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            #region init form
            string caption = "Thêm mới loại tiêu chí đánh giá chất lượng KTV";
            if (!string.IsNullOrEmpty(_documentid))
                caption = "Thông tin loại tiêu chí đánh giá chất lượng KTV";
