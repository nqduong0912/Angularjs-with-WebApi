...
{
    public partial class QuanLyBoTieuChiKeHoachNam_Input : PageBase
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            Button btnAdd = (Button) _Form.FindControl("btnAddTCC") as Button;
            btnAdd.Attributes.Add("onclick", "{btnAddTCC_Onclick(); return false;}");
            #endregion
        }
        /// <summary>
        /// Page_Load
