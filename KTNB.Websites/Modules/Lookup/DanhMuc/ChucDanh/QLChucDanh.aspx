<%@ Page Title="" Language="C#" MasterPageFile="~/Share/Wsp.master" AutoEventWireup="true" CodeBehind="QLChucDanh.aspx.cs" Inherits="VPB_KTNB.Modules.Lookup.DanhMuc.ChucNang.QLChucDanh" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="FormContent" runat="server">
            ...
            <td>
                <C1WebGrid:C1WebGrid runat="server" ID="dataCtrl" Width="100%" DataSourceID="ObjectDataSource1"
                    ...
                    <Columns>
                        ...
                        <C1WebGrid:C1BoundColumn HeaderText="Tên chức danh" DataField="Tên chức danh">
    ...
    <script type="text/javascript">
        ...
        /*********************************************************/
        function newform() {
            window.location.href = "QLChucDanh_Input.aspx";
        }
        function LoadDocument(DocumentID) {
            url = "QLChucDanh_Input.aspx?act=loaddoc&doc=" + DocumentID;
