<%@ Page Title="" Language="C#" MasterPageFile="~/Share/Wsp.master" AutoEventWireup="true" CodeBehind="QLQuytrinhActivitySanpham.aspx.cs" Inherits="VPB_KTNB.Modules.Lookup.DanhMuc.ChucDanh.QLQuytrinhActivitySanpham" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="FormContent" runat="server">
    ...
    <table width="70%">
        <tr>
            <td>
                <C1WebGrid:C1WebGrid runat="server" ID="dataCtrl" Width="100%" DataSourceID="ObjectDataSource1" OnItemCreated="dataCtrl_OnItemCreated" OnItemDataBound="dataCtrl_OnItemDataBound" GroupIndent="20" ItemStyle-Height="30px">
                    <Columns>
                        ...
                        <C1WebGrid:C1BoundColumn HeaderText="Quy trình/activity/sản phẩm" DataField="Quy trình/activity/sản phẩm">
                            <ItemStyle VerticalAlign="Top" HorizontalAlign="Left" />
                        </C1WebGrid:C1BoundColumn>
    ...
    <script type="text/javascript">
        ...
        /*********************************************************/
        function newform() {
            window.location.href = "QLQuytrinhActivitySanpham_Input.aspx";
        }
        function LoadDocument(DocumentID) {
            url = "QLQuytrinhActivitySanpham_Input.aspx?act=loaddoc&doc=" + DocumentID;
