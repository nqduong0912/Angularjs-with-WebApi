...
{
    public partial class QLQuytrinhActivitySanpham : PageBase
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            #region init form
            base.InitForm("Quản lý quy trình/activity/sản phẩm", string.Empty, _doctypeid, 0);
        ...
        {
            string DocFields = "PK_DocumentID,Status,[Mảng nghiệp vụ],[Quy trình/activity/sản phẩm],[Diễn giải]";
            string PropertyFields = "Mảng nghiệp vụ,Quy trình/activity/sản phẩm,Diễn giải";
            string Condition = " Order By [Mảng nghiệp vụ]";
