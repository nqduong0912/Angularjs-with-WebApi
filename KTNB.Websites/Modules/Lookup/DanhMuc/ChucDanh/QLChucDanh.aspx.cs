...
{
    public partial class QLChucDanh : PageBase
    {
        protected string _action = string.Empty;
        public string _doctypeid = DOCTYPE.CHUCDANH;
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            #region init form
            base.InitForm("Danh mục Chức danh", string.Empty, _doctypeid, 0);
        ...
        {
            string DocFields = "PK_DocumentID,Status,[Tên chức danh],[Diễn giải]";
            string PropertyFields = "Tên chức danh,Diễn giải";
