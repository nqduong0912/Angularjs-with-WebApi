...
{
    public partial class HinhThucXuLyLuatLaoDong : PageBase
    {
        #region initiation page variables
        protected string _action = string.Empty;
        protected string _doctypeid = DOCTYPE.HINHTHUCXULY_LUATLAODONG;
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            #region init form
            base.InitForm("Danh mục Hình thức xử lý theo luật lao động", string.Empty, _doctypeid, 0);
        ...
        {
            string DocFields = "PK_DocumentID,[Hình thức xử lý],[Diễn giải]";
            string PropertyFields = "Hình thức xử lý,Diễn giải";
