...
{
    public partial class NhomHanhViViPham_Input : PageBase
    {
        #region initiation page variables
        protected string _action = string.Empty;
        protected string _doctypeid = DOCTYPE.NHOMHANHVI_VIPHAM;
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            #region init form
            string caption = "Thêm mới Nhóm hành vi vi phạm";
            if (!string.IsNullOrEmpty(_documentid))
                caption = "Thông tin Nhóm hành vi vi phạm";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                CommonFunc.GetLookUpValue("D94F69C8-D205-4FB3-9305-593B67B70C10", this.ID8_D94F69C8_D205_4FB3_9305_593B67B70C10, 0);
                if (!string.IsNullOrEmpty(_action))
                    if (_action == "loaddoc")
                    {
