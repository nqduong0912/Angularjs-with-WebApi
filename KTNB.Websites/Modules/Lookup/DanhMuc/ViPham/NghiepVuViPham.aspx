<%@ Page Title="" Language="C#" MasterPageFile="~/Share/Wsp.master" AutoEventWireup="true" CodeBehind="NghiepVuViPham.aspx.cs" Inherits="VPB_KTNB.Modules.Lookup.DanhMuc.ViPham.NghiepVuViPham" %>
        ...
        <td>
            <C1WebGrid:C1WebGrid runat="server" ID="dataCtrl" Width="100%" DataSourceID="ObjectDataSource1"
                    ...
                    <Columns>
                        ...
                        <C1WebGrid:C1BoundColumn HeaderText="Tên nghiệp vụ" DataField="Tên nghiệp vụ">
...
<script type="text/javascript">
    ...
    /*********************************************************/
    function newform() {
        window.location.href = "NghiepVuViPham_Input.aspx";
    }
    function LoadDocument(DocumentID) {
        url = "NghiepVuViPham_Input.aspx?act=loaddoc&doc=" + DocumentID;
