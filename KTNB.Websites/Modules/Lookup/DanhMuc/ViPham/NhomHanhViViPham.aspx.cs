...
{
    public partial class NhomHanhViViPham : PageBase
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            #region init form
            base.InitForm("Nhóm hành vi vi phạm", string.Empty, _doctypeid, 0);
        ...
        {
            string DocFields = "PK_DocumentID,[Tên nhóm],[Diễn giải],[Nghiệp vụ vi phạm]";
            string PropertyFields = "Tên nhóm,Diễn giải,Nghiệp vụ vi phạm";
