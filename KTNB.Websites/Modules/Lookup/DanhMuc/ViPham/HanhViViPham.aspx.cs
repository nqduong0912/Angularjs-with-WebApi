...
{
    public partial class HanhViViPham : PageBase
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            #region init form
            base.InitForm("Danh mục Hành vi vi phạm", string.Empty, _doctypeid, 0);
        ...
        {
            string DocFields = "PK_DocumentID,Status,[Tên hành vi],[Diễn giải],[Nhóm hành vi vi phạm]";
            string PropertyFields = "Tên hành vi,Diễn giải,Nhóm hành vi vi phạm";
