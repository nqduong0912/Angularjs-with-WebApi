...
{
    public partial class TieuChiChinh : PageBase
    {
            ...
            protected override void OnInit(EventArgs e)
            {
                ...
                #region init form
                base.InitForm("Danh mục tiêu chí chính", string.Empty, _doctypeid, 0);
            ...
            {
                string DocFields = "PK_DocumentID,Status,[Tên],[Diễn giải],[Tên bộ tiêu chí],[Công thức],[Tỷ trọng]";
                string PropertyFields = "Tên,Diễn giải,Tên bộ tiêu chí,Công thức,Tỷ trọng";
