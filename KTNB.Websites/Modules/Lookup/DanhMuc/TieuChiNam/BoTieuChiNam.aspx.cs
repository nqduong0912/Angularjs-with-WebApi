...
namespace VPB_KTNB.Modules.Lookup.DanhMuc.TieuChiNam
        ...
        /// <summary>
{
    public partial class BoTieuChiNam : PageBase
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            #region init form
            base.InitForm("Các bộ tiêu chí năm", string.Empty, _doctypeid, 0);
        ...
        {
            string DocFields = "PK_DocumentID,Status,[Tên bộ tiêu chí năm],[Công thức],[Diễn giải]";
            string PropertyFields = "Tên bộ tiêu chí năm,Công thức,Diễn giải";
