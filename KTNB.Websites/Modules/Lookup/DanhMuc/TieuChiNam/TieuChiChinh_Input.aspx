...
<asp:Content ID="Content1" ContentPlaceHolderID="FormContent" runat="server">   
    <div class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <a href="javascript:;" onclick="return CheckFormValid();" class="btn btn-default" style="width: 172px; float: right">Thêm tiêu chí thành phần</a>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group<%= isUpdate %>">
            ...
            <div class="col-sm-8">
                ...
                <a href="javascript:;" onclick="Add2Formula();" class="btn btn-default" style="width: 160px; margin: 0 0 0 10px !important; float: left;">Thêm vào công thức</a>
            </div>
        </div>
        <div class="form-group<%= isUpdate %>">
        ...
        <div class="form-group<%= isUpdate %>">
            ...
            <div class="col-sm-8">
                <div class="col-sm-2" style="padding-left: 0 !important;">
                    <a href="javascript:;" onclick="Add2FormulaWithOperator(' + ');" class="col-sm-12 btn btn-default">+</a>
                </div>
                <div class="col-sm-2" style="padding-left: 0 !important;">
                    <a href="javascript:;" onclick="Add2FormulaWithOperator(' - ');" class="col-sm-12 btn btn-default">-</a>
                </div>
                <div class="col-sm-2" style="padding-left: 0 !important;">
                    <a href="javascript:;" onclick="Add2FormulaWithOperator(' x ');" class="col-sm-12 btn btn-default">x</a>
                </div>
                <div class="col-sm-2" style="padding-left: 0 !important;">
                    <a href="javascript:;" onclick="Add2FormulaWithOperator(' : ');" class="col-sm-12 btn btn-default">:</a>
                </div>
        ...
        <div class="form-group<%= isUpdate %>">
            ...
            <div class="col-sm-8">
                ...
                <a href="javascript:;" onclick="Clear2Formula();" class="col-sm-3 btn btn-default" style="margin: 0 0 0 10px !important; float: left;">Làm lại</a>
            </div>
        </div>
    </div>
