...
{
    public partial class TieuChiDanhGiaXacSuatAnhHuong : PageBase
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            #region init form
            base.InitForm("Tiêu chí đánh giá ảnh hưởng xác suất/ảnh hưởng", string.Empty, _doctypeid, 0);
        ...
        private void GetList(string DocumentTypeID)
        {
           ...
           // string DocFields = "PK_DocumentID,[Tên tiêu chí],[Diễn giải],[Điểm 1],[Điểm 2],[Điểm 3],[Điểm 4],[Điểm 5]";
            ...
            string Condition = " Order By [Nhóm tiêu chí đánh giá]";
