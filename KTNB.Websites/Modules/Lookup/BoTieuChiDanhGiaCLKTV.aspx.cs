...
{
    public partial class BoTieuChiDanhGiaCLKTV : PageBase
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            #region init form
            base.InitForm("Bộ tiêu chí đánh giá", string.Empty, _doctypeid, 0);
        ...
        protected override void dataCtrl_OnItemDataBound(object sender, C1ItemEventArgs e)
        {
            ...
            if ((elemType == C1ListItemType.AlternatingItem) || (elemType == C1ListItemType.Item))
            {
                ...
                Image imgSetTieuChi = (Image)e.Item.FindControl("imgSetTieuChi") as Image;
                Image imgSetLoaiTieuChi = (Image)e.Item.FindControl("imgSetLoaiTieuChi") as Image;

                if (PK_DocumentID != null)
                {
                    imgEdit.Attributes.Add("onclick", "{LoadDocument('" + PK_DocumentID.Text + "')}");
                    imgSetTieuChi.Attributes.Add("onclick", "{ThemChiTietCacTieuChi('" + PK_DocumentID.Text + "')}");
                    imgSetLoaiTieuChi.Attributes.Add("onclick", "{ThemChiTietLoaiTieuChi('" + PK_DocumentID.Text + "')}");
                }
