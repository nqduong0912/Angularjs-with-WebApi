<%@ Page Title="" Language="C#" MasterPageFile="~/Share/Wsp.master" AutoEventWireup="true" CodeBehind="CongViecTheoQuyMoDotKiemSoat.aspx.cs" Inherits="VPB_TDHS.Modules.Lookup.CongViecTheoQuyMoDotKiemSoat" %>
        ...
        <td>
            <C1WebGrid:C1WebGrid runat="server" ID="dataCtrl" Width="100%" DataSourceID="ObjectDataSource1"
                    ...
                    <Columns>
                        ...
                        <C1WebGrid:C1BoundColumn HeaderText="Tên công việc" DataField="Tên công việc">
                            <ItemStyle VerticalAlign="Top" HorizontalAlign="Left" />
                        </C1WebGrid:C1BoundColumn>
                        <C1WebGrid:C1BoundColumn HeaderText="Số lượng trưởng đoàn" DataField="Số lượng trưởng đoàn">
                            <ItemStyle VerticalAlign="Top" HorizontalAlign="Left" />
                        </C1WebGrid:C1BoundColumn>
...
<script type="text/javascript">
    ...
    /*********************************************************/
    function newform() {
        window.location.href = "CongViecTheoQuyMoDotKiemSoat_Load.aspx";
    }
    function LoadDocument(DocumentID) {
        url = "CongViecTheoQuyMoDotKiemSoat_Load.aspx?act=loaddoc&doc=" + DocumentID;
