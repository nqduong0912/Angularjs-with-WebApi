...
{
    public partial class RuiRoChinh : PageBase
    {
        #region initiation page variables
        protected string _action = string.Empty;
        protected string _doctypeid = DOCTYPE.RUIRO_CHINH;
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            #region init form
            base.InitForm("Danh mục rủi ro chính",string.Empty,_doctypeid,0);
        ...
        {
            string DocFields = "PK_DocumentID,[Tên],[Diễn Giải],[Trạng Thái]";
            string PropertyFields = "Tên,Diễn Giải,Trạng Thái";
        ...
        protected override void dataCtrl_OnItemDataBound(object sender, C1ItemEventArgs e)
        {
            ...
            if ((elemType == C1ListItemType.AlternatingItem) || (elemType == C1ListItemType.Item))
            {
                ...
                Label RRPhu = (Label)e.Item.FindControl("RRPhu") as Label;
                ...
                if (PK_DocumentID != null)
                {
                    ...
                    RRPhu.Attributes.Add("onclick", "{LoadRRPhu('" + PK_DocumentID.Text + "');}");
                }
                if (Status != null)
                {
                    if (Status.Text == "2")
