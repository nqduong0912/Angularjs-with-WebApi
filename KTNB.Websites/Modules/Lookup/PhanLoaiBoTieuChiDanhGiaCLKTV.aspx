<%@ Page Title="" Language="C#" MasterPageFile="~/Share/Wsp.master" AutoEventWireup="true" CodeBehind="PhanLoaiBoTieuChiDanhGiaCLKTV.aspx.cs" Inherits="VPB_TDHS.Modules.Lookup.PhanLoaiBoTieuChiDanhGiaCLKTV" %>
        ...
        <td>
            <C1WebGrid:C1WebGrid runat="server" ID="dataCtrl" Width="100%" DataSourceID="ObjectDataSource1"
                    ...
                    <Columns>
                        ...
                        <C1WebGrid:C1BoundColumn HeaderText="Tên phân loại bộ tiêu chí đánh giá" DataField="Tên phân loại bộ tiêu chí đánh giá">
...
<script type="text/javascript">
    ...
    /*********************************************************/
    function newform() {
        window.location.href = "PhanLoaiBoTieuChiDanhGiaCLKTV_Load.aspx";
    }
    function LoadDocument(DocumentID) {
        url = "PhanLoaiBoTieuChiDanhGiaCLKTV_Load.aspx?act=loaddoc&doc=" + DocumentID;
