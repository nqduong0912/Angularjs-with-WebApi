...
{
    public partial class TieuChiDanhGiaKTV : PageBase
    {
        #region initiation page variables
        protected string _action = string.Empty;
        protected string _doctypeid = DOCTYPE.TIEUCHI_DANHGIA_CHATLUONG_KTV;
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            #region init form
            base.InitForm("Tiêu chí đánh giá chất lượng KTV", string.Empty, _doctypeid, 0);
        ...
        {
            string DocFields = "PK_DocumentID,[Tên tiêu chí đánh giá],[Loại tiêu chí đánh giá],[Diễn giải],Status";
            string PropertyFields = "Tên tiêu chí đánh giá,Loại tiêu chí đánh giá,Diễn giải";
