...
{
    public partial class MainView_Mainviewer : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string url;
            this.fraToc.Attributes["src"] = "FolderViewer.aspx?op=" + _op + "&docspace=" + _docspace + "&a=" + _applicationid + "&c=" + _componentid + "&an=" + _applicationname + "&cn=" + _componentname + "&u=" + _objUserContext.UserName;
