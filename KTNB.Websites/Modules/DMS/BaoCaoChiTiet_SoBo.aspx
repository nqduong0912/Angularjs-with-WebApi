...
<asp:Content ID="Content1" ContentPlaceHolderID="FormContent" runat="server">
    ...
    <table width="100%">
         <tr>
            ...
            <td style="width:25%">
                <asp:DropDownList ID="ddlDotKiemToan" CssClass="form-control" runat="server" Width="200px" />        
            </td>
           <td >
                <asp:Button runat="server" ID="btnView" Text="Xem" CssClass="btn btn-default" />
           </td>
        </tr>
        <tr>
            <td >
            ...
            <td>
                <asp:TextBox ID="txtDoiTuongKiemToan" runat="server" ReadOnly="true" CssClass="form-control" />
            </td>
            <td></td>
        </tr>
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtDonViKiemToan" runat="server" ReadOnly="true" CssClass="form-control" />
            </td>
             <td></td>
        </tr>
       ...
       <tr>
            ...
            <td>
             <input id="btn-baocao" style="width: 100px;" type="button" class="btn btn-primary" onclick="XuatBaoCao();" value="Xuất báo cáo" />
            </td>
        </tr>
    </table>
