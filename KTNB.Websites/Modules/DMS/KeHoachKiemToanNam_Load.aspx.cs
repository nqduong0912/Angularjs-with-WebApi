...
{
    public partial class KeHoachKiemToanNam_Load : PageBase
    {
        #region initiation page variables
        protected string _action = string.Empty;
        protected string _doctypeid = DOCTYPE.KEHOACH_KIEMTOAN_NAM;
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            #region init form
            string caption = "Thêm mới kế hoạch kiểm toán năm";
            if (!string.IsNullOrEmpty(_documentid))
                caption = "Thông tin kế hoạch kiểm toán năm";
