...
{
    public partial class TruongDoan_CapNhatPhanHoi : PageBase
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            #region init form
            base.InitForm("Trưởng đoàn cập nhật phản hồi", string.Empty, _doctypeid, 0);
            //_isTruongDoan = CommonFunc.IsTruongDoan(_dotkt, _objUserContext.UserName);
            //if (_isTruongDoan)
            //    _btnAddNew.Visiblâ = true;
            //else
        ...
        protected void dataCtrl1_ItemDataBound(object sender, C1ItemEventArgs e)
        {
            ...
            if ((elemType == C1ListItemType.AlternatingItem) || (elemType == C1ListItemType.Item))
            {
                ...
                if (PK_DocumentID != null && Kieu != null)
                {
                    ...
                    lblTongSoPhanHoi.Attributes.Add("onclick", "{LoadPagePhanHoiDonVi('" + PK_DocumentID.Text + "')}");
                }
                if (lblTrangThai != null)
        ...
        public string UpdateStatus_BBKT(string dotkt)
        {
            ...
            //return message;
            string message = TrangThaiDotKiemToan.SetStatus(dotkt, 231);
            if (message == "1")
            {
                message = isDanhGiaRRConLai(_doankt);
                return message;
