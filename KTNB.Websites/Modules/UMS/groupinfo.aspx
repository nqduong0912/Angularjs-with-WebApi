<%@ Page Language="C#" MasterPageFile="~/Share/Wsp.master" AutoEventWireup="true" Inherits="VPB_PROMOTION.UMS.UMS_groupinfo" CodeBehind="groupinfo.aspx.cs" %>
...
<asp:Content runat="server" ID="NewUser" ContentPlaceHolderID="FormContent">
    <div class="form-horizontal ">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <asp:DropDownList ID="cboBranches" runat="server" CssClass="form-control">
                </asp:DropDownList>
            </div>
        </div>
    ...
    <%--<table style="width: 100%">
        ...
        <tr class="lblNormal">
            ...
            <td>
                <asp:DropDownList ID="cboBranches" runat="server" SkinID="DropDownList" Width="75%">
                </asp:DropDownList></td>
            <td></td>
            <td style="width: 113px"></td>
        </tr>
    ...
    <script type="text/javascript">
        ...
        function updategroup() {
            ...
            var parentgroup = $("#ctl00_FormContent_cboBranches").val();
        ...
        function toogleCNQuanLy() {
            if ($("#ctl00_FormContent_chkTrungTamHT").attr("checked")) {
                $("#ctl00_FormContent_cboBranches").attr("selectedIndex", 0);
                $("#ctl00_FormContent_cboBranches").attr("disabled", true);
            }
            else {
                $("#ctl00_FormContent_cboBranches").attr("disabled", false);
            }
        }
        $(document).ready(function () {
            if ($("#ctl00_FormContent_chkTrungTamHT").attr("checked")) {
