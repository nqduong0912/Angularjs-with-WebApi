...
function buildPopup_Frame(width, height, title, framesrc) {
    ...
    document.write('<div id="postit_title" class="title"><b>' + _title + ' <span class="spantitle"><img src="../../Images/closepopup.gif" border="0" title="Đóng" align="right" WIDTH="11" HEIGHT="11" onclick="closeit()">&nbsp;</b></span></div>');
