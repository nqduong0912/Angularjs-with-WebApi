...
<body id="page-login">
                    ...
                    <div class="login-panel">
                        ...
                        <div class="body-form">
                            <div role="form">
                                ...
                                <div class="btn-login">
                                    <asp:Button runat="server" ID="LoginButton" CssClass="btn btn-lg btn-success btn-block" Text="Đăng nhập" />
    ...
    <script type="text/javascript" src="<%= this.ResolveUrl("~/Scripts/jquery-1.11.3.min.js") %>"></script>
    <script type="text/javascript" src="<%= this.ResolveUrl("~/Scripts/jquery.blockUI.js") %>"></script>
    <script type="text/javascript" src="<%= this.ResolveUrl("~/Javascript/BackEndProcess.js") %>"></script>
