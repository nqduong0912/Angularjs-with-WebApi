<%@ Page Title="" Language="C#" MasterPageFile="~/Share/Wsp.master" AutoEventWireup="true" CodeBehind="RuiRoChinh.aspx.cs" Inherits="VPB_TDHS.Modules.Lookup.RuiRoChinh" %>
        ...
        <td>
            <C1WebGrid:C1WebGrid runat="server" ID="dataCtrl" Width="100%" DataSourceID="ObjectDataSource1"
                    ...
                    <Columns>
                        ...
                        <C1WebGrid:C1TemplateColumn HeaderText="RR phụ">
                            <ItemTemplate>
                                <asp:Label runat="server" ID="RRPhu" Text='0' CssClass="lblCaption" style="cursor:pointer"></asp:Label>
                            </ItemTemplate>
                            <ItemStyle Width="8%" HorizontalAlign="Center" VerticalAlign="Middle" />
                        </C1WebGrid:C1TemplateColumn>
                        <C1WebGrid:C1BoundColumn HeaderText="Tên RR chính" DataField="Tên">
...
<script type="text/javascript">
    ...
    /*********************************************************/
    function newform() {
        window.location.href = "RuiRoChinh_Load.aspx";
    }
    function LoadDocument(DocumentID) {
        url = "RuiRoChinh_Load.aspx?act=loaddoc&doc=" + DocumentID;
        window.location.href = url;
    }
    function LoadRRPhu(DocumentID_RRChinh) {
        url = "RuiRoPhu.aspx?doc=" + DocumentID_RRChinh;
        window.location.href = url;
    }
</script>
</asp:Content>
