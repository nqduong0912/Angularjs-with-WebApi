<%@ Page Title="" Language="C#" MasterPageFile="~/Share/Wsp.master" AutoEventWireup="true" CodeBehind="RuiRoKiemSoat.aspx.cs" Inherits="VPB_TDHS.Modules.Lookup.RuiRoKiemSoat" %>
        ...
        <td>
            <C1WebGrid:C1WebGrid runat="server" ID="dataCtrl" Width="100%" DataSourceID="ObjectDataSource1"
                    ...
                    <Columns>
                        ...
                        <%--<C1WebGrid:C1BoundColumn HeaderText="Mục tiêu kiểm soát" DataField="Mục tiêu kiểm soát" RowMerge="Restricted">
                            <ItemStyle VerticalAlign="Top" HorizontalAlign="Left" />
                            <GroupInfo HeaderText="Mục tiêu kiểm soát: {0}" Position="Header" OutlineMode="StartCollapsed"></GroupInfo>
                        </C1WebGrid:C1BoundColumn>--%>
                        <C1WebGrid:C1BoundColumn Visible="false" HeaderText="Mục tiêu kiểm soát" DataField="Mục tiêu kiểm soát" RowMerge="Restricted">
                            <ItemStyle VerticalAlign="Top" HorizontalAlign="Left" />
                            <GroupInfo HeaderText="Mục tiêu kiểm soát: {0}" Position="Header" OutlineMode="StartCollapsed"></GroupInfo>
                        </C1WebGrid:C1BoundColumn>
                        <C1WebGrid:C1BoundColumn  HeaderText="Tên rủi ro kiểm soát" DataField="Tên rủi ro kiểm soát">
                            <ItemStyle VerticalAlign="Top" HorizontalAlign="Left" />
...
<script type="text/javascript">
    ...
    /*********************************************************/
    function newform() {
        window.location.href = "RuiRoKiemSoat_Load.aspx";
    }
