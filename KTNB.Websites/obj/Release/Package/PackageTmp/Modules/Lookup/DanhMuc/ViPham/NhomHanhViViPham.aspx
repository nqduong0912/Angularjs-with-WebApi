<%@ Page Title="" Language="C#" MasterPageFile="~/Share/Wsp.master" AutoEventWireup="true" CodeBehind="NhomHanhViViPham.aspx.cs" Inherits="VPB_KTNB.Modules.Lookup.DanhMuc.ViPham.NhomHanhViViPham" %>
        ...
        <td>
            <C1WebGrid:C1WebGrid runat="server" ID="dataCtrl" Width="100%" DataSourceID="ObjectDataSource1"
                    ...
                    <Columns>
                        ...
                        <C1WebGrid:C1BoundColumn HeaderText="Tên nhóm" DataField="Tên nhóm">
                            <ItemStyle VerticalAlign="Top" HorizontalAlign="Left" />
                        </C1WebGrid:C1BoundColumn>
                        <C1WebGrid:C1BoundColumn HeaderText="Diễn giải" DataField="Diễn giải">
                            <ItemStyle VerticalAlign="Top" HorizontalAlign="Left" />
                        </C1WebGrid:C1BoundColumn>
                        <C1WebGrid:C1BoundColumn HeaderText="Nghiệp vụ vi phạm" DataField="Nghiệp vụ vi phạm">
                            <ItemStyle VerticalAlign="Top" HorizontalAlign="Left" />
                        </C1WebGrid:C1BoundColumn>
                    </Columns>
            </C1WebGrid:C1WebGrid>
...
<script type="text/javascript">
    ...
    /*********************************************************/
    function newform() {
        window.location.href = "NhomHanhViViPham_Input.aspx";
    }
    function LoadDocument(DocumentID) {
        url = "NhomHanhViViPham_Input.aspx?act=loaddoc&doc=" + DocumentID;
