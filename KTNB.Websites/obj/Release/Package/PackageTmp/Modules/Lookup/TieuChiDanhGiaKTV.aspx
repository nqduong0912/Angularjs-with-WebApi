<%@ Page Title="" Language="C#" MasterPageFile="~/Share/Wsp.master" AutoEventWireup="true" CodeBehind="TieuChiDanhGiaKTV.aspx.cs" Inherits="VPB_TDHS.Modules.Lookup.TieuChiDanhGiaKTV" %>
        ...
        <td>
            <C1WebGrid:C1WebGrid runat="server" ID="dataCtrl" Width="100%" DataSourceID="ObjectDataSource1"
                    ...
                    <Columns>
                        ...
                        <C1WebGrid:C1BoundColumn HeaderText="Tên" DataField="Tên tiêu chí đánh giá">
                            <ItemStyle VerticalAlign="Top" HorizontalAlign="Left" />
                        </C1WebGrid:C1BoundColumn>


                          <C1WebGrid:C1BoundColumn HeaderText="Loại tiêu chí đánh giá" DataField="Loại tiêu chí đánh giá">
                            <ItemStyle VerticalAlign="Top" HorizontalAlign="Left" />
                        </C1WebGrid:C1BoundColumn>
...
<script type="text/javascript">
    ...
    /*********************************************************/
    function newform() {
        window.location.href = "TieuChiDanhGiaKTV_Load.aspx";
    }
    function LoadDocument(DocumentID) {
        url = "TieuChiDanhGiaKTV_Load.aspx?act=loaddoc&doc=" + DocumentID;
