<%@ Page Title="" Language="C#" MasterPageFile="~/Share/Wsp.master" AutoEventWireup="true" CodeBehind="MangNghiepVu.aspx.cs" Inherits="VPB_TDHS.Modules.Lookup.MangNghiepVu" %>
        ...
        <td>
            <C1WebGrid:C1WebGrid runat="server" ID="dataCtrl" Width="100%" DataSourceID="ObjectDataSource1"
                    ...
                    <Columns>
                        ...
                        <C1WebGrid:C1BoundColumn HeaderText="Tên" DataField="Tên mảng nghiệp vụ">
                     ...
                     <%--   <C1WebGrid:C1BoundColumn HeaderText="Loại đối tượng kiểm toán" DataField="Loại đối tượng kiểm toán" RowMerge="Restricted" Visible="false">
                            <ItemStyle VerticalAlign="Top" HorizontalAlign="Left" />
                            <GroupInfo HeaderText="Loại đối tượng: {0}" Position="Header" OutlineMode="StartCollapsed"></GroupInfo>
                        </C1WebGrid:C1BoundColumn>--%>
...
<script type="text/javascript">
    ...
    /*********************************************************/
    function newform() {
        window.location.href = "MangNghiepVu_Load.aspx";
    }
    function LoadDocument(DocumentID) {
        url = "MangNghiepVu_Load.aspx?act=loaddoc&doc=" + DocumentID;
