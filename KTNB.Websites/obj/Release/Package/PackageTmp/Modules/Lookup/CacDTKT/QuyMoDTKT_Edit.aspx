...
<asp:Content ID="Content1" ContentPlaceHolderID="FormContent" runat="server">
    <div data-ng-controller="quyMoDoiTuongKiemToanEditController" data-ng-init="initFunc('<%= _id %>')">
        ...
        <div class="form-horizontal">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <select class="form-control" data-ng-model="item.Nam" data-ng-options="nam as nam for nam in DanhSachNam" data-ng-change="namChangeFunc()"></select>
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-3 col-sm-offset-1 col-xs-4">
                ...
                <div class="col-sm-6">
                    <select class="form-control" data-ng-model="item.LoaiDTKT" data-ng-options="loaidoituongkiemtoan for loaidoituongkiemtoan in DanhSachLoaiDoiTuongKiemToan" data-ng-change="loaiDoiTuongKiemToanChangeFunc()"></select>
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-3 col-sm-offset-1 col-xs-4">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" required data-ng-model="item.Ten" />
                </div>
            </div>
        </div>
        ...
        <div class="text-center">
            <button type="button" class="btn btn-xs btn-success btn-submit" data-ng-click="updateFunc()">Lưu</button>
