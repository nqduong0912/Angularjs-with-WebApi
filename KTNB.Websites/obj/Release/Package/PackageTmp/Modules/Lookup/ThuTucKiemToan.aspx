<%@ Page Title="" Language="C#" MasterPageFile="~/Share/Wsp.master" AutoEventWireup="true" CodeBehind="ThuTucKiemToan.aspx.cs" Inherits="VPB_TDHS.Modules.Lookup.ThuTucKiemToan" %>
...
<script type="text/javascript">
    ...
    /*********************************************************/
    function newform() {
        window.location.href = "ThuTucKiemToan_Load.aspx";
    }
