<%@ Page Language="C#" AutoEventWireup="true" Inherits="VPB_PROMOTION.MainView.MainView_FolderViewer" Codebehind="FolderViewer.aspx.cs" Buffer="false"%>
...
<body onload="folderload()">
    ...
    <form id="frmFolderView" runat="server" style="display:none">
        <div>
<%--            <asp:ScriptManager runat="server" ID="scrMgn_FolderViewer"></asp:ScriptManager>
