<%@ Page Title="" Language="C#" MasterPageFile="~/Share/Wsp.master" AutoEventWireup="true" CodeBehind="ReViewDotKiemToan_BLD.aspx.cs" Inherits="VPB_TDHS.Modules.DMS.ReViewDotKiemToan_BLD" %>
...
<asp:ObjectDataSource runat="server" ID="ObjectDataSource1" SelectMethod="getList"
                        ...
                        <C1WebGrid:C1TemplateColumn>
                            <ItemTemplate>
                                ...
                                <asp:Image runat="server" ID="imgEdit" ImageUrl="~/Images/viewdetail.gif" ToolTip="Chi tiết đợt kiểm toán"
                                  ...
                                  <asp:Image runat="server" ID="imgReView" ImageUrl="~/Images/status_16.png" Width="16" Height="16" ToolTip="BLĐ Phê duyệt/Từ chối kết thúc đợt kiểm toán"
                                    Style="cursor: pointer" />
                            </ItemTemplate>
    ...
    <script type="text/javascript">
        ...
        function LoadDocumentReViewDotKT_BLD(doankt, dotkt) {
            url = "ReviewDotKiemToan.aspx?act=bld&doankt=" + doankt + "&dotkt=" + dotkt;
            window.location.href = url;
        }
