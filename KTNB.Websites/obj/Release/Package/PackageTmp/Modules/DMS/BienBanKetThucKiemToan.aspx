...
<asp:Content ID="Content1" ContentPlaceHolderID="FormContent" runat="server">
    ...
    <table width="100%">
        ...
        <tr>
            ...
            <td>
                <input id="btn-baocao" style="width: 100px;" type="button" class="PrintButton" onclick="BaoCao();"
                    value="Xuất báo cáo" />
            </td>
        </tr>
    </table>
    ...
    <asp:Button runat="server" Visible="false" ID="btnReport" Text="Báo cáo" SkinID="PrintButton"
